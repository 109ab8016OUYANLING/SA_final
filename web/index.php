...
header('content-type:text/html;charset=utf-8');
	...
	if( $selected_val != 'None' ){
		$sql = "SELECT * FROM makeorder WHERE OrderID = '$selected_val'";
	$result = $conn->query($sql);
	$rowOrder = mysqli_fetch_assoc($result);
	
	$sql = "SELECT * FROM iwork WHERE MakeOrder = '$selected_val' ";
	$result = $conn->query($sql);
	$rowIWork = mysqli_fetch_assoc($result);
	
	$sql = "SELECT * FROM owork WHERE MakeOrder = '$selected_val' ";
	$result = $conn->query($sql);
	$rowOWork = array();
...
<body class="framed main-scrollable" onload="ShowTime()">
    <div class="wrapper">
            ...
            <div class="topnavbar">
              ...
              <ul class="dropdown-menu">
                ...
                <ul class="userbar nav navbar-nav">
					<li style="font-size: 12px;color:white;position: absolute;top:37.5%;right:5%"><div id="showbox"></div></li>
                                                ...
                                                <div class="ov-widget">
                                                    <div class="ov-widget__list">
                                                        <div class="ov-widget__item ov-widget__item_inc">
                                                            <div class="ov-widget__value" align="center"><div id="lightSign"></div></div>
                                                            <div class="ov-widget__info">
                                                                <!--<div class="ov-widget__title">1,950</div>-->
                                                                <!--<div class="ov-widget__change"><span>趙品淵臭ㄌㄐㄌㄐㄌㄐㄌㄐㄌㄐ</span>-->
                                                    ...
                                                    <div class="ov-widget__item ov-widget__item_inc">
                                                        ...
                                                        <div class="ov-widget__info">
                                                            <!--<div class="ov-widget__title">1,950</div>-->
                                                            <div class="ov-widget__change"><span><!--15--><div id = "Temp"></div></span>
                                                                <!--<span class="fa fa-level-up"></span><span class="fa fa-level-down"></span><span class="fa fa-bolt"></span><span class="fa fa-thumb-tack"></span>*--></div>
                                                        </div>
                                                    </div>
                                                    <div class="ov-widget__item ov-widget__item_dec">
                                                        ...
                                                        <div class="ov-widget__info">
                                                            ...
                                                            <div class="ov-widget__change"><span id="Time"></span>
                                                                <!--<span class="fa fa-level-up"></span><span class="fa fa-level-down"></span><span class="fa fa-bolt"></span><span class="fa fa-thumb-tack"></span>--></div>
                                                        </div>
                                                    </div>
													<div class="ov-widget__item ov-widget__item_dec">
                                                        <div class="ov-widget__value">轉換率</div>
                                                        <div class="ov-widget__info">
                                                            <div class="ov-widget__title">
                                                                <!--$3,230-->
                                                            </div>
                                                            <div class="ov-widget__change"><span id = "myrate"></span>
                                                                <!--<span class="fa fa-level-up"></span><span class="fa fa-level-down"></span><span class="fa fa-bolt"></span><span class="fa fa-thumb-tack"></span>--></div>
                                                        </div>
                                                    </div>
													<div class="ov-widget__item ov-widget__item_LS">
                                                        <div class="ov-widget__value">目前計米</div>
                                                        <div class="ov-widget__info">
                                                            <!--<div class="ov-widget__title">1,950</div>-->
                                                            <div class="ov-widget__change"><span><!--15--><div id = "No_meter"></div></span>
                                                                <!--<span class="fa fa-level-up"></span><span class="fa fa-level-down"></span><span class="fa fa-bolt"></span><span class="fa fa-thumb-tack"></span>*--></div>
                                                        </div>
                                                    </div>
													<div class="ov-widget__item ov-widget__item_IS">
                                                        <div class="ov-widget__value">投入線速</div>
                                                        <div class="ov-widget__info">
                                                            <div class="ov-widget__title">
                                                                <!--$3,230-->
                                                            </div>
                                                            <div class="ov-widget__change"><span id = "ISpeed"></span>
                                                                <!--<span class="fa fa-level-up"></span><span class="fa fa-level-down"></span><span class="fa fa-bolt"></span><span class="fa fa-thumb-tack"></span>--></div>
                                                        </div>
                                                    </div>
													<div class="ov-widget__item ov-widget__item_OS">
                                                        <div class="ov-widget__value">產出線速</div>
                                                        <div class="ov-widget__info">
                                                            <div class="ov-widget__title">
                                                                <!--$3,230-->
                                                            </div>
                                                            <div class="ov-widget__change"><span id = "OSpeed"></span>
                                                                <!--<span class="fa fa-level-up"></span><span class="fa fa-level-down"></span><span class="fa fa-bolt"></span><span class="fa fa-thumb-tack"></span>--></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="feed-widget__list">
                                                        <div class="feed-widget__item feed-widget__item_user">
                                                            ...
                                                            <div class="feed-widget__info">
                                                                ...
                                                                <div class="feed-widget__date"><div id = "IID"></div></div>
                                                            </div>
                                                        </div>
                                                        <div class="feed-widget__item feed-widget__item_product">
                                                            ...
                                                            <div class="feed-widget__info">
                                                                ...
                                                                <div class="feed-widget__date"><div id = "IL"></div></div>
                                                            </div>
                                                        </div>
                                                        <div class="feed-widget__item feed-widget__item_order">
                                                            <div class="feed-widget__ico"><i class="fa fa-fighter-jet"></i></div>
                                                            <div class="feed-widget__info">
                                                                <div class="feed-widget__text"><b>投入線速：</b></div>
                                                                <div class="feed-widget__date"><div id = "IISpeed"></div></div>
                                                            </div>
                                                        </div>
														<div class="feed-widget__item feed-widget__item_user">
                                                            <div class="feed-widget__ico"><i class="fa fa-arrows-h" aria-hidden="true"></i>
                                                                <!--<i class="fa fa-fw"></i>--></div>
                                                            <div class="feed-widget__info">
                                                                <div class="feed-widget__text"><b>線段長度：</b>
                                                                    <!-- has registered.-->
                                                                </div>
                                                                <div class="feed-widget__date"><div id="i_meter"></div></div>
                                                            </div>
                                                        </div>
                                                        <div class="feed-widget__item feed-widget__item_subscriber">
                                                            ...
                                                            <div class="feed-widget__info">
                                                                ...
                                                                <div class="feed-widget__date"><div id="IStartT"></div></div>
                                                            </div>
                                                        </div>
                                                        <div class="feed-widget__item feed-widget__item_subscriber">
                                                            <div class="feed-widget__ico"><i class="fa fa-clock-o"></i></div>
                                                            <div class="feed-widget__info">
                                                                ...
                                                                <div class="feed-widget__date"><div id="IEndT"></div></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="panel panel-danger">
                                        <div class="panel-heading panel-heading_label">
                                            ...
                                            <div class="label label-danger"><?php if( $selected_val != 'None' )echo count($rowOWork);?></div>
                                        </div>
                                        <div class="feed-widget">
                                            <div class="feed-widget__wrap scrollable scrollbar-macosx">
                                                <div class="feed-widget__cont">
                                                    <div class="feed-widget__list">
                                                        <div class="feed-widget__item feed-widget__item_user">
                                                            ...
                                                            <div class="feed-widget__info">
                                                                ...
                                                                <div class="feed-widget__date"><div id = "OID"></div></div>
                                                            </div>
                                                        </div>
                                                        <div class="feed-widget__item feed-widget__item_product">
                                                            <div class="feed-widget__ico"><i class="fa fa-google-wallet"></i></div>
                                                            <div class="feed-widget__info">
                                                                ...
                                                                <div class="feed-widget__date"><div id = "OL"></div></div>
                                                            </div>
                                                        </div>
                                                        <div class="feed-widget__item feed-widget__item_order">
                                                            <div class="feed-widget__ico"><i class="fa fa-fighter-jet"></i></div>
                                                            <div class="feed-widget__info">
                                                                <div class="feed-widget__text"><b>產出線速：</b></div>
                                                                <div class="feed-widget__date"><div id = "OOSpeed"></div></div>
                                                            </div>
                                                        </div>
														<div class="feed-widget__item feed-widget__item_user">
                                                            <div class="feed-widget__ico"><i class="fa fa-arrows-h" aria-hidden="true"></i>
                                                            ...
                                                            <div class="feed-widget__info">
                                                                ...
                                                                <div class="feed-widget__date"><div id="o_meter"></div></div>
                                                            </div>
                                                        </div>
                                                        <div class="feed-widget__item feed-widget__item_subscriber">
                                                            <div class="feed-widget__ico"><i class="fa fa-clock-o"></i></div>
                                                            <div class="feed-widget__info">
                                                                <div class="feed-widget__text"><b>開始時間：</b></div>
                                                                <div class="feed-widget__date"><div id="OStartT"></div></div>
                                                            </div>
                                                        </div>
                                                        <div class="feed-widget__item feed-widget__item_subscriber">
                                                            <div class="feed-widget__ico"><i class="fa fa-clock-o"></i></div>
                                                            <div class="feed-widget__info">
                                                                <div class="feed-widget__text"><b>結束時間：</b></div>
                                                                <div class="feed-widget__date"><div id="OEndT"></div></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="feed-widget__cont">
                                                    <div class="feed-widget__list">
                                                        <div class="st-widget__item st-widget__item_select">
                                                            <div class="st-widget__label">製令編號：<?php echo $selected_val;?></div>
                                                            <div class="st-widget__select">
                                                                <form action="#" method="post">
																	<select class="selectpicker form-control"  name="Order">
													...
													<!--style="width:60px;font-size:14px;color:black;float:right;"-->
                                                        ...
                                                        <div class="feed-widget__item feed-widget__item_product">
                                                            ...
                                                            <div class="feed-widget__info">
                                                                ...
                                                                <div class="feed-widget__date"><?php if( $selected_val != 'None' )echo $rowOrder['IPartNumber'];?></div>
                                                            </div>
                                                        </div>
                                                        <div class="feed-widget__item feed-widget__item_order">
                                                            ...
                                                            <div class="feed-widget__info">
                                                                ...
                                                                <div class="feed-widget__date"><?php if( $selected_val != 'None' )echo $rowOrder['ILong'];?> m</div>
                                                            </div>
                                                        </div>
                                                        <div class="feed-widget__item feed-widget__item_subscriber">
                                                            ...
                                                            <div class="feed-widget__info">
                                                                ...
                                                                <div class="feed-widget__date"><?php if( $selected_val != 'None' )echo $rowOrder['INum'];?></div>
                                                            </div>
                                                        </div>
                                                        <div class="feed-widget__item feed-widget__item_subscriber">
                                                            <div class="feed-widget__ico"><i class="fa fa-info-circle"></i></div>
                                                            <div class="feed-widget__info">
                                                                ...
                                                                <div class="feed-widget__date"><?php if( $selected_val != 'None' )echo $rowOrder['OPartNumber'];?></div>
                                                            </div>
                                                        </div>
                                                        <div class="feed-widget__item feed-widget__item_subscriber">
                                                            ...
                                                            <div class="feed-widget__info">
                                                                ...
                                                                <div class="feed-widget__date"><?php if( $selected_val != 'None' )echo $rowOrder['OLong'];?> m</div>
                                                            </div>
                                                        </div>
                                                        <div class="feed-widget__item feed-widget__item_subscriber">
                                                            ...
                                                            <div class="feed-widget__info">
                                                                ...
                                                                <div class="feed-widget__date"><?php if( $selected_val != 'None' )echo $rowOrder['ONum'];?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
	...
	<?php if( $selected_val != 'None' ){
	echo "<script type='text/javascript' src='../js/IMlinegraph.js'></script>";
	echo "<script type='text/javascript' src='../js/update_rate.js'></script>";
	echo "<script type='text/javascript' src='../js/update.js'></script>";
	echo "<script type='text/javascript' src='../js/updateIW.js'></script>";
	echo "<script type='text/javascript' src='../js/updateLight.js'></script>";
	echo "<script type='text/javascript' src='../js/updateWW.js'></script>";
	}
	?>
</body>
